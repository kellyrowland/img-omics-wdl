...
#          imgap_input_fasta = "${split}"+"/"+"${imgap_input_fasta}",
	  imgap_input_fasta = "/global/projectb/sandbox/omics/marcelh/nmdc/benchmarking_datasets/runs/2020-10-23/241871/Ga0400806_contigs.fna",
    ...
    if(fa_execute) {
      call fa.f_annotate {
        input:
          ...
          input_contigs_fasta="${split}"+"/"+"${imgap_input_fasta}",
